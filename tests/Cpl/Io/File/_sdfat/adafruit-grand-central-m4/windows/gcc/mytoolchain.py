...
base_release.inc         += r' -I' + ARDUINO_SKETCH_FOLDER + r'\libraries\SdFat\src'
base_release.inc         += r' -I' + ARDUINO_SKETCH_FOLDER + r'\libraries\Adafruit_SPIFlash\src'
base_release.inc         += r' -I' + ARDUINO_SKETCH_FOLDER + r'\libraries\Adafruit_Zero_DMA_Library'

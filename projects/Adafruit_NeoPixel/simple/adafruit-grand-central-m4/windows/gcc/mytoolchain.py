...
base_release.cflags       = ' -DBUILD_OPT_PIN=6 -DBUILD_OPT_NUM_PIXELS=6 -DBUILD_OPT_NEO_TYPE=NEO_GRBW -Wall -DF_CPU=120000000L -DARDUINO=10810 -DVARIANT_QSPI_BAUD_DEFAULT=50000000 -DENABLE_CACHE '

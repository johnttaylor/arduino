...
"TimedOut"->"WaitingForHomed"[label=<isAckTimerExpired()<br ALIGN="LEFT"/>>  color=black, fontname=arial, fontcolor=black]; //TimedOut WaitingForHomed
...
"Spinning"[shape=record, color=black, fontname=arial, style=rounded, label=<{<B>Spinning</B><br ALIGN="LEFT"/>|<br ALIGN="LEFT"/>}>];"defaultroot"[label=< >,shape=circle, fontsize=8, fixedsize=true, height=0.2, width=0.2, fillcolor=black, style=filled];

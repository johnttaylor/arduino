...
#define GOLEMSHELLCMD_USAGE_OUTPUT_      "out\n" \
                                         "out debug\n"  \
                                         "out neo (all|2|4|2spin|2spincc|4spin|4spincc)\n"
...
public:
    /// Constructor
    Output( Golem::Main& application, const char* initialPolicyName, Cpl::Container::Map<Cpl::TShell::Dac::Command>& commandList ) throw();

    /// Constructor.  Used to create a static instance of the command
    Output( Golem::Main& application, const char* initialPolicyName, Cpl::Container::Map<Cpl::TShell::Dac::Command>& commandList, const char* ignoreThisParameter_onlyUsedWhenCreatingAStaticInstance ) throw();
